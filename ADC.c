...
/*
There are four steps required to perform a software-start conversion
The range is 0 to 3.3V. If the analog input is 0,digital 
output will be 0, and if the analog input is 3.3V, 4095.
